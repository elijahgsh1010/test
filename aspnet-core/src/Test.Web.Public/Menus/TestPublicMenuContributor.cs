...
namespace Test.Web.Public.Menus
{
    public class TestPublicMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public TestPublicMenuContributor(IConfiguration configuration)
        {
