...
namespace Test.Migrations
{
    ...
    [Migration("20210801171236_Add_Client_Group_Entities")]
    partial class Add_Client_Group_Entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test.Company.Company", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Test.Family.Family", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Test.SurerClient.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Test.SurerClient.ClientGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Test.SurerClient.ClientGroupRelation", b =>
                {
                    ...
                    b.HasKey("ClientId", "CompanyId", "FamilyId");

                    b.HasIndex("CompanyId");

                    b.HasIndex("FamilyId");

                    b.ToTable("ClientGroupRelation");
                });
            ...
            modelBuilder.Entity("Test.SurerClient.Client", b =>
                {
                    b.HasOne("Test.SurerClient.ClientGroup", null)
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("Test.SurerClient.ClientGroup", b =>
                {
                    b.HasOne("Test.Company.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId");

                    b.HasOne("Test.Family.Family", "Family")
                        .WithMany()
            ...
            modelBuilder.Entity("Test.SurerClient.ClientGroupRelation", b =>
                {
                    b.HasOne("Test.SurerClient.Client", "Client")
                        .WithMany("ClientGroupRelations")
            ...
            modelBuilder.Entity("Test.SurerClient.Client", b =>
                {
                    b.Navigation("ClientGroupRelations");
                });
